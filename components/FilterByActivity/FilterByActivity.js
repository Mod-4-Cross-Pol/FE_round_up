  ...
  return (
    <View style={styles.filterContainer}>
      ...
      <ModalDropdown
        ...
        options={[ 'Show all events', 'Show custom events', 'Baseball', 'Basketball', 'Biking', 'Bocce ball', 'Climbing', 'Croquet', 'Disc golf', 'Fishing', 'Football', 'Hand ball', 'Kickball', 'Outdoor exercising', 'Slacklining', 'Soccer', 'Spike ball', 'Tennis', 'Trail hiking/walking', 'Ultimate frisbee', 'Volleyball']}
      />
    </View>
  );
}
